...
EXPERIMENTS["ablate_modules"] = ([j for v in ABL_MODULES for j in
                                  cv_jobs([42], backbone="chemberta_mlm", variant=v)]
                                 + [j for v in ABL_MODULES for j in
                                    cv_jobs([42], split="scaffold", backbone="chemberta_mlm", variant=v)]
                                 # the no-potency reference is missing on the scaffold split
                                 + cv_jobs([42], split="scaffold", backbone="chemberta_mlm",
                                           variant="graph_branch"))
