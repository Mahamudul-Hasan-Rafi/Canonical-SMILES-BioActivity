...
def main():
    ...
    cands = [("V3, single seed (42), 5 models", runs[0]["oof"], runs[0]["ens"]),
             ...
             ("Blend: 0.5 x DL ensemble + 0.5 x XGBoost", 0.5 * dl_oof + 0.5 * xo, 0.5 * dl_te + 0.5 * xt)]
    ...
    for name, a, b in [("seed ensemble vs single-seed V3", (seed_oof, seed_te), (runs[0]["oof"], runs[0]["ens"])),
